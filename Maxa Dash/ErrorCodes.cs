...
namespace Maxa_Dash
{
    public static class ErrorCodes
    {
        ...
        public static Err DigBlockCom2                  = new Err(950, 12, "Digital block compressor 2", 013);
        public static Err DigBlockFan2                  = new Err(950, 13, "Digital block fan 2", 14);
        ...
        public static Err ModulGiProbe3                 = new Err(952, 13, "modul Gi - Probe 3", 632);
        public static Err ModulGiProbe4                 = new Err(952, 14, "modul Gi - Probe 4", 642);
        public static Err ModulGiProbe5                 = new Err(952, 15, "modul Gi - Probe 5", 652);

        // Register 953 Errors
        public static Err ModulGiProbe6                 = new Err(953, 0, "modul Gi - Probe 6", 662);
        public static Err ModulGiProbe7                 = new Err(953, 1, "modul Gi - Probe 7", 672);
        public static Err ModulGiProbe8                 = new Err(953, 2, "modul Gi - Probe 8", 682);
        public static Err ModulGiProbe9                 = new Err(953, 3, "modul Gi - Probe 9", 692);
        public static Err ModulGiProbe10                = new Err(953, 4, "modul Gi - Probe 10", 702);
        public static Err ModulGiProbe11                = new Err(953, 5, "modul Gi - Probe 11", 712);

        // Register 954 Errors
        public static Err LinkInverter1                 = new Err(954, 1, "Link inverter 1", 801);
        public static Err LinkInverter2                 = new Err(954, 2, "Link inverter 2", 802);
        public static Err HWFaultInverter1              = new Err(954, 4, "Hardware fault inverter 1", 851);
        public static Err HWFaultInverter2              = new Err(954, 5, "Hardware fault inverter 2", 852);
        public static Err OverCurrentInverter1          = new Err(954, 7, "Overcurrent inverter 1", 861);
        public static Err OverCurrentInverter2          = new Err(954, 8, "Overcurrent inverter 2", 862);
        public static Err HighTempInverter1             = new Err(954, 10, "High temperature inverter 1", 871);
        public static Err HighTempInverter2             = new Err(954, 11, "High temperature inverter 2", 872);
        public static Err BadVoltInverter1              = new Err(954, 13, "Bad voltage inverter 1", 881);
        public static Err BadVoltInverter2              = new Err(954, 14, "Bad voltage inverter 2", 882);

        // Register 955 Errors
        public static Err PhSequenceInverter1           = new Err(955, 0, "Phase sequence inverter 1", 891);
        public static Err PhSequenceInverter2           = new Err(955, 1, "Phase sequence inverter 2", 892);
        public static Err ModelErrInverter1             = new Err(955, 3, "Model error inverter 1", 901);
        public static Err ModelErrInverter2             = new Err(955, 4, "Model error inverter 2", 902);
        public static Err OLErrInverter1                = new Err(955, 6, "Overload error inverter 1", 911);
        public static Err OLErrInverter2                = new Err(955, 7, "Overload error inverter 2", 912);
        public static Err OverCurrentPFCInverter1       = new Err(955, 9, "Overcurrent PFC inverter 1", 921);
        public static Err OverCurrentPFCInverter2       = new Err(955, 10, "Overcurrent PFC inverter 2", 922);
        public static Err InternalComErrInverter1       = new Err(955, 12, "Internal communication error inverter 1", 931);
        public static Err InternalComErrInverter2       = new Err(955, 13, "Internal communication error inverter 2", 932);
